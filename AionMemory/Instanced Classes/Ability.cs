    ...
    public class Ability
    {
        ...
        public void MatchHotbar()
        {
            ...
            for (int bars = 0; bars <= 3; bars++)
            {
                ...
                for (int i = 0; i < 12; i++)
                {
                    long caddress = Process.Modules.Game + 0xAB6C00 + thisbar + (i * 0xC);
        ...
        public void Update()
        {
            ...
            if (PtrAbility != -1 && ((AbilityID < 30002 || AbilityID > 30003) && (AbilityID < 40001 || AbilityID > 40009) && (AbilityID < 50007 || AbilityID > 50037)))
            {
