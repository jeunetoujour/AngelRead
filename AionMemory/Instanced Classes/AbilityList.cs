...
namespace AngelRead
{
    public class AbilityList: IEnumerable<Ability>
    {
        ...
        public void Update()
        {
            ...
            int headPtr = (int)Memory.ReadUInt(Process.handle, (uint)(Process.Modules.Game + 0xA76CC4));//A2439C
            headPtr = (int)Memory.ReadUInt(Process.handle, (uint)(headPtr + 0x1EC)); //1e4
